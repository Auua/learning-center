...
reviewed: 
created: 2026-08-29
tags: [grammar/ehto, jlpt/n4]
---

> [!abstract] Ydin
> Joustavin ehtolause: "kun/jos A on tapahtunut, niin B". Ainoa, jonka jälkilauseessa saa vapaasti käskeä, pyytää ja ehdottaa.

## Merkitys
- **FI:** jos / kun (A:n tapahduttua)
- **EN:** if / when (once A happens)

## Muodostus
| Mihin liittyy | Kaava | Esimerkki |
|---|---|---|
| Verbi | [[た-muoto]] + ら | 行った → 行ったら |
| い-adjektiivi | かった + ら | 安い → 安かったら |
| な-adjektiivi | だった + ら | 静か → 静かだったら |
| Substantiivi | だった + ら | 雨 → 雨だったら |
| Kielto | なかった + ら | 行かない → 行かなかったら |

Käytetyt taivutusmuodot: [[た-muoto]]

## Nyanssi ja rajoitukset
- Konkreettinen, usein kertaluontoinen tilanne — ei yleinen luonnonlaki.
...
## Esimerkit
![[Lausepankki — Ehtolauseet#^tara1]]
![[Lausepankki — Ehtolauseet#^tara2]]
![[Lausepankki — Ehtolauseet#^tara3]]
![[Lausepankki — Määritelmät ja epäsuorat kehotukset#^maar9]]
![[Lausepankki — Määritelmät ja epäsuorat kehotukset#^maar10]]
![[Lausepankki — Vertailut ja syy-seuraussuhteet#^vert8]]
![[Lausepankki — Vertailut ja syy-seuraussuhteet#^vert9]]

## Sekaannusvaara
Vertailu: [[Vertailu — Ehtolauseet と・ば・たら・なら]]
- ×京都に行けば、写真を撮ってください。→ ○京都に行っ**たら**、…
- なら:n kanssa aikajärjestys kääntyy: 日本に行く**なら**、ガイドブックを買ったほうがいい (kirja ostetaan ennen matkaa).

## Kuvavihje
Aikajana: 🅰️ ──▶ 🅱️ — た on menneisyyden muoto, joten A on aina "valmis" ennen B:tä.

## Kortit
#flashcards/grammar/n4

たら — muodostus ja mitä jälkilauseessa saa olla?
?
V-た + ら (安かったら / 雨だったら). Jälkilauseessa saa olla käsky, pyyntö, kutsu ja toive — toisin kuin と ja ば. A tapahtuu ennen B:tä.
